...
#peer channel create -o orderer.example.com:7050 -c iraschannel -f ./channel-artifacts/channel.tx \
...
CORE_PEER_ADDRESS=peer0.org2.iras.com:7051 peer channel join -b iraschannel.block
CORE_PEER_ADDRESS=peer1.org2.iras.com:7051 peer channel join -b iraschannel.block

CORE_PEER_ADDREE=peer0.org2.iras.com:7051 peer channel update --channelID iraschannel --file ./channel-artifacts/iraschannel.anchor.org2 --orderer orderer.iras.com:7050
